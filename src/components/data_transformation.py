...
from sklearn.impute import SimpleImputer #Handline missing value
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_data_path, test_data_path):
        try:
            ...
            train_array = np.c_[input_feature_train_arr, np.array(target_feature_train_df)] # To contact array with dataframe and later convert entirely to array
            ...
            logging.info('Error occured in Reading the data')
            raise CustomException(e, sys)